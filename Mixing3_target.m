function [R1, R2,R3,R4, Td] = Mixing3(Target_1, Target_2,Target_3, Fs, x, y, x_sen, y_sen, p)
...
d_S3_R4 = sqrt(((abs(y(3)-y_sen(4)))^2)+((abs(x(3)-x_sen(4)))^2));
%% Transmission Loss
k = [d_S1_R1 d_S1_R2 d_S1_R3 d_S1_R4 d_S2_R1 d_S2_R2 d_S2_R3 d_S2_R4 d_S3_R1 d_S3_R2 d_S3_R3 d_S3_R4];
...
S3_R1= Target_3*(1/k(9));
S3_R2= Target_3*(1/k(10));
S3_R3= Target_3*(1/k(11));
S3_R4= Target_3*(1/k(12));
%% Time delay
c = 1500; % sound speed
...
L_S3_R4 = length(0:1/Fs:TD_S3_R4);
...
Td = max([L_S1_R1 L_S1_R2 L_S1_R3 L_S1_R4 L_S2_R1 L_S2_R2 L_S2_R3 L_S2_R4 L_S3_R1 L_S3_R2 L_S3_R3 L_S3_R4]);
