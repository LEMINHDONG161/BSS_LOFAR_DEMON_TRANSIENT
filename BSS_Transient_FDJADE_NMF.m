...
for i=1
   %Wa1(:,i) = ((1./Wa1(:,i)));
    ...
    XmagHat2 = Wa1(:,i)*(Ha2(i,:));
    XmagHat1 = Wa2(:,i)*(Ha1(i,:));
...
figure,
set(gcf,'numbertitle','off','name', ' raw Target signal');
for ii = 1:size(Ds_T_STFT,2)
    subplot(2,1,ii)
      surf(T_LOFAR_T,F_LOFAR_T,abs(Ds_T_STFT{1,ii}));
...
figure, set(gcf,'numbertitle','off','name', '1_Recieved signal');
