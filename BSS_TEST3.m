...
[R1_a, R2_a,R3_a,R4_a, Td] = Mixing3(Target_1, Target_2, Fs, x, y, x_sen, y_sen, p);
R1 = R1_a;
R2 = R2_a;
R3 = R3_a;
R4 = R4_a;
...
Ds_deci_4 = decimate(Ds(4,:),sc);
Ds_deci = [Ds_deci_1; Ds_deci_2; Ds_deci_3 ;  Ds_deci_4 ]; % DEMON (Resampling)
...
[Ds_STFT3,F_DEMON,T_DEMON] = stft(Ds_deci(3,:),win,overlap,nfft,dfs);
[Ds_STFT4,F_DEMON,T_DEMON] = stft(Ds_deci(4,:),win,overlap,nfft,dfs);% STFT 2
