function [R1, R2,R3, Td] = Mixing2(Target_1, Target_2, Fs, x, y, x_sen, y_sen, p)
...
%% Transmission Loss
k = [d_S1_R1 d_S1_R2 d_S1_R3 d_S2_R1 d_S2_R2 d_S2_R3];
...
Td = max([L_S1_R1 L_S1_R2 L_S1_R3 L_S2_R1 L_S2_R2 L_S2_R3]);
...
R1 = S1_R1+S2_R1+S1_R1_M1+S1_R1_M2+S2_R1_M+(WNs(1,:)*(1/dep));
R2 = S1_R2+S2_R2+S2_R2_M1+S2_R2_M2+S1_R2_M+(WNs(1,:)*(1/(dep-x_sen(2))));
R3 = S1_R3+S2_R3+S1_R3_M1+S1_R3_M2+S2_R3_M+S2_R3_M1+S2_R3_M2 +S1_R3_M;
