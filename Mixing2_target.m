function [R1,R2,R3, Td] = Mixing2_target(Target_1, Target_2, Target_3, Fs, x, y, x_sen, y_sen, p)

% S1: Source 1, S2: Source 2, S3: Source 3
% R1: Sensor 1, R2: Sensor 2 R3 Sensor 3
...
d_S3_R1 = sqrt(((abs(y(3)-y_sen(1)))^2)+((abs(x(3)-x_sen(1)))^2));
d_S3_R2 = sqrt(((abs(y(3)-y_sen(2)))^2)+((abs(x(3)-x_sen(2)))^2));
d_S3_R3 = sqrt(((abs(y(3)-y_sen(3)))^2)+((abs(x(3)-x_sen(3)))^2));
%% Transmission Loss
k = [d_S1_R1 d_S1_R2 d_S1_R3 d_S2_R1 d_S2_R2 d_S2_R3 d_S3_R1 d_S3_R2 d_S3_R3 ];

S1_R1= Target_1*(1/k(1));
S1_R2= Target_1*(1/k(2));
S1_R3= Target_1*(1/k(3));
S2_R1= Target_2*(1/k(4));
S2_R2= Target_2*(1/k(5));
S2_R3= Target_2*(1/k(6));
S3_R1= Target_3*(1/k(7));
S3_R2= Target_3*(1/k(8));
S3_R3= Target_3*(1/k(9));
%% Time delay
c = 1500; % sound speed
...
L_S3_R1 = length(0:1/Fs:TD_S3_R1);
L_S3_R2 = length(0:1/Fs:TD_S3_R2);
L_S3_R3 = length(0:1/Fs:TD_S3_R3);
...
Td = max([L_S1_R1 L_S1_R2 L_S1_R3 L_S2_R1 L_S2_R2 L_S2_R3 L_S3_R1 L_S3_R2 L_S3_R3 ]);

%% Multi path
S1_R1_M1 = 0.7*S1_R1_M; S1_R1_M2 = 0.5*S1_R1_M;
S2_R2_M1 = 0.7*S2_R2_M; S2_R2_M2 = 0.5*S2_R2_M;
S3_R3_M1 = 0.7*S3_R3_M; S3_R3_M2 = 0.5*S3_R3_M;
...
S3_R3_M1(1,1:LTT1) = 0; S3_R3_M2(1,1:LTT2) = 0;
...
TL_N = [db2mag(-TL_N1) db2mag(-TL_N2) db2mag(-TL_N3) ];
...
R1 = S1_R1+ S2_R1+ S3_R1;
R2 = S1_R2+S2_R2 +S3_R2 ;
R3 = S1_R3+S2_R3 +S3_R3;
